<!-- resources/views/livewire/includes/admin/purchase-order-details.blade.php -->
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div class="flex flex-col">
                ...
                <input type="text" wire:model="supplier" id="supplier"
                    class="block w-full pl-2 text-base text-black bg-white border border-black rounded-md shadow h-9 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-gray-300" readonly>
            </div>
            <!-- Tel No. Field -->
            <div class="flex flex-col">
                ...
                <div class="flex flex-col gap-3">
                    <div class="flex flex-col gap-3">
                        <div class="flex flex-col gap-1">
                            ...
                            <div class="block w-full h-[100px] px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring" readonly>
                                Sample goods
                            </div>
                        </div>
                        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                            <div class="flex flex-col gap-1">
                                <label for="po_auth" class="block font-bold text-gray-700 truncate">Authorized Official</label>
                                <input type="text" wire:model="po_auth" id="po_auth"
                                    class="w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring" readonly>
                            </div>
                            <div class="flex flex-col gap-1">
                    ...
                    <div class="flex flex-col gap-3">
                        <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                            <div class="flex flex-col gap-1">
                                <label for="po_cfa" class="block font-bold text-gray-700 truncate">CFA Certified by</label>
                        ...
                        <div>
                            ...
                            <select wire:model="po_status" id="po_status"
                                class="block w-full pl-2 text-base text-black bg-white border border-black rounded-md shadow h-9 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-gray-300" disabled>
