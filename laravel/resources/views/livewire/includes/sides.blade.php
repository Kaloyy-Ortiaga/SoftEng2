<div class="flex flex-col w-[16%] max-md:ml-0 max-md:w-full">
    <div
        ...
        <div class="flex justify-between gap-5 mb-72 mt-14 whitespace-nowrap max-md:mt-10">
            <img loading="lazy"
        ...
        <div class="flex justify-between gap-5 mt-96 whitespace-nowrap max-md:mt-10">
            ...
            <div class="self-start flex-auto mt-0 truncate whitespace-normal">LOGOUT</div>
        </div>
    </div>
</div>
