                    ...
                    @foreach ($prsItems as $index => $item)
                        <tr class="border-b border-black">
                            ...
                            <th scope="row" class="px-1 py-3 border-r border-black">
                                ...
                                @error('prsItems.' . $index . '.stock_no') <span class="text-red-500">{{ $message }}</span> @enderror
                            </th>
                            <td class="px-1 py-3 border-r border-black">
                                ...
                                @error('prsItems.' . $index . '.unit') <span class="text-red-500">{{ $message }}</span> @enderror
                            </td>
                            <td class="px-1 py-3 border-r border-black">
                                ...
                                @error('prsItems.' . $index . '.item_description') <span class="text-red-500">{{ $message }}</span> @enderror
                            </td>
                            <td class="px-1 py-3 border-r border-black">
                                ...
                                @error('prsItems.' . $index . '.quantity') <span class="text-red-500">{{ $message }}</span> @enderror
                            </td>
                            <td class="px-1 py-3 border-r border-black">
                                ...
                                @error('prsItems.' . $index . '.unit_cost') <span class="text-red-500">{{ $message }}</span> @enderror
                            </td>
                            <td class="px-1 py-3">
