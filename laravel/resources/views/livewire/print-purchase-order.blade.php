            ...
            <div class="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
                ...
                <div class="flex flex-col ml-9 w-[84%] max-md:ml-0 max-md:w-full">
                    ...
                    <div id="printContent"
                        ...
                        @include('livewire.includes.print-purchase-order-content', ['purchaseOrder' => $purchaseOrder])
                    </div>
                </div>
            </div>
        </div>
...
<script>
    function goBack() {
        ...
        if (previousPage.includes('/admin/detail-po/')) {
            window.location.href = previousPage;
        } else {
            window.location.href = '{{ route('purchase-order-view') }}';
        }
    }
